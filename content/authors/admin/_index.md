...
My research investigates whether large foundation models (e.g., LLM and VLM) develop a **latent world models** across modalities such as text, vision, and speech. Latent world modelling refers to a model’s latent understanding of the environment and agent dynamics, thus enabling reasoning and planning without an external, specialised world model. Specifically, my interest spans:
